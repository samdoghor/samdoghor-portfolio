...
app = Flask(__name__)
cors = CORS(app, resources={r"/*": {"origins": ["http://localhost:5173", "samdoghor-portfolio-frontend-95tv1ddtj-samdoghor.vercel.app", "https://app.samdoghor.com/", "https://www.app.samdoghor.com/"]}})  # noqa: E501
